...
Этот рецепт демонстрирует реализацию на RxJS игры, похожей на «Танковый бой».
...
![Танковый бой](https://drive.google.com/uc?export=view&id=1-QeeMZCtd9rp60m9C9yphMW5vs0jQxYW)
...
> _Перевод документации Learn RxJS. Источник: https://www.learnrxjs.io/learn-rxjs/recipes/tank-battle-game. Оригинал распространяется по лицензии MIT._
