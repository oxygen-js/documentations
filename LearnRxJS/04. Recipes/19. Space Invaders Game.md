...
Этот рецепт демонстрирует реализацию игры «Space Invaders» на RxJS.
...
![Space Invaders](https://drive.google.com/uc?export=view&id=1s3JUvMEKVDMroou92mCtGHr9-qu89KWL)
...
> _Перевод документации Learn RxJS. Источник: https://www.learnrxjs.io/learn-rxjs/recipes/space-invaders-game. Оригинал распространяется по лицензии MIT._
