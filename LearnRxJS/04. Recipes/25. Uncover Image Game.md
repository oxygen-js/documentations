...
Этот рецепт демонстрирует реализацию игры Uncover Image на RxJS.
...
> _Перевод документации Learn RxJS. Источник: https://www.learnrxjs.io/learn-rxjs/recipes/uncover-image-game. Оригинал распространяется по лицензии MIT._
