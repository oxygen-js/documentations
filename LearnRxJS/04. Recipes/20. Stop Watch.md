...
Этот рецепт демонстрирует реализацию секундомера на RxJS, вдохновлённую докладом
[RxJS Advanced Patterns – Operate Heavily Dynamic UI’s](https://www.youtube.com/watch?v=XKfhGntZROQ)
от [@Michael_Hladky](https://twitter.com/michael_hladky)
...
![Секундомер](https://drive.google.com/uc?export=view&id=14kiNGgR8laJq4a2gEvInNyTPXLVbWH5l)
...
- [merge](<../02. Operators/07. Transformation/11. map.md>)
- NEVER
- noop
...
> _Перевод документации Learn RxJS. Источник: https://www.learnrxjs.io/learn-rxjs/recipes/stop-watch. Оригинал распространяется по лицензии MIT._
