...
Этот рецепт демонстрирует реализацию на RxJS цифрового дождя из «Матрицы».
...
> _Перевод документации Learn RxJS. Источник: https://www.learnrxjs.io/learn-rxjs/recipes/matrix-digital-rain. Оригинал распространяется по лицензии MIT._
