# Игра Alphabet Invasion

_Автор: [adamlubek](https://github.com/adamlubek)_

Этот рецепт демонстрирует реализацию игры Alphabet Invasion на RxJS.
...
> _Перевод документации Learn RxJS. Источник: https://www.learnrxjs.io/learn-rxjs/recipes/alphabet-invasion-game. Оригинал распространяется по лицензии MIT._
