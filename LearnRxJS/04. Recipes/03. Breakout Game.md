...
Этот рецепт демонстрирует реализацию игры Breakout на RxJS.
...
![Breakout](https://drive.google.com/uc?export=view&id=1unsdGI5UBZu9ECjFtA4t_hLl4l7CRBSE)
...
> _Перевод документации Learn RxJS. Источник: https://www.learnrxjs.io/learn-rxjs/recipes/breakout-game. Оригинал распространяется по лицензии MIT._
