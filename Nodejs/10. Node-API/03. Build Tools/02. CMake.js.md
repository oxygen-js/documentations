...
[CMake.js](https://github.com/cmake-js/cmake-js) — хорошая альтернатива инструменту сборки [node-gyp](<01. node-gyp.md>). CMake.js основан на инструменте [CMake](https://cmake.org), который должен быть установлен.
