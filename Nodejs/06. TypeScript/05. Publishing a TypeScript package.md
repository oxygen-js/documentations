...
Несколько важных моментов, которые стоит отметить:
  ...
  * Всё из статьи [Публикация пакета](<../07. Modules/03. Publishing a package.md>) применимо и здесь.
