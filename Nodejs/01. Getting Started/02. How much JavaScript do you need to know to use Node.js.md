# Насколько хорошо нужно знать JavaScript, чтобы использовать Node.js?

Будучи новичком, трудно достичь точки, в которой вы достаточно уверены в своих навыках программирования. Изучая программирование, вы также можете путаться в том, где заканчивается JavaScript и где начинается Node.js, и наоборот.

### Что рекомендуется изучить, прежде чем глубоко погружаться в Node.js?
  ...
  * [Переменные](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Grammar_and_types#declarations)
  ...
  * [ECMAScript 2015 (ES6) и далее](<06. ECMAScript 2015 (ES6) and beyond.md>)
  * [Асинхронный JavaScript](https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Async_JS)

Держа в голове эти концепции, вы на верном пути к тому, чтобы стать умелым JavaScript-разработчиком как в браузере, так и в Node.js.
...
Следующие концепции также являются ключевыми для понимания асинхронного программирования, которое является одной из фундаментальных частей Node.js:
  ...
  * [Асинхронное программирование и колбэки](https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Async_JS/Introducing)
...
> _Перевод официальной документации Node.js (раздел Learn). Источник: <https://nodejs.org/en/learn/getting-started/how-much-javascript-do-you-need-to-know-to-use-nodejs>. Оригинал распространяется по лицензии MIT._
